...
void computeAngles(TLorentzVector p4M11, 
    ...
    Phi=helicityAimuthalAngle(p4H,p4H_target,p4M21,p4M22);
...
//int lhe_conversion_HZZ(TString argv="100kevt1000.lhe") {
    ...
    double Px_Beamp, Py_Beamp, Pz_Beamp, E_Beamp;
    double Px_Beamm, Py_Beamm, Pz_Beamm, E_Beamm;
    double Px_Z, Py_Z, Pz_Z, E_Z;
    double Px_H, Py_H, Pz_H, E_H;
    double Px_H_Z, Py_H_Z, Pz_H_Z, E_H_Z;
    double Px_H_Zs, Py_H_Zs, Pz_H_Zs, E_H_Zs;
    double Px_Z_Mup, Py_Z_Mup, Pz_Z_Mup, E_Z_Mup;
    double Px_Z_Mum, Py_Z_Mum, Pz_Z_Mum, E_Z_Mum;
    double Px_H_Z_Mup, Py_H_Z_Mup, Pz_H_Z_Mup, E_H_Z_Mup;
    double Px_H_Z_Mum, Py_H_Z_Mum, Pz_H_Z_Mum, E_H_Z_Mum;
    double Px_H_Zs_Mup, Py_H_Zs_Mup, Pz_H_Zs_Mup, E_H_Zs_Mup;
    double Px_H_Zs_Mum, Py_H_Zs_Mum, Pz_H_Zs_Mum, E_H_Zs_Mum;
    ...
    while ( reader.readEvent() ) 
    {
        ...
        computeAngles(P4_H_Z_Mup.at(0), P4_H_Z_Mum.at(0), P4_H_Zs_Mup.at(0), P4_H_Zs_Mum.at(0),  costhetas, costheta1, costheta2, phi, phi1);
